...
When a JavaScript program generated by :ref:`sloppy-javascript-quine` or :ref:`picky-javascript-quine` is run, it has access to a JavaScript object that acts as a client for calling back to the Cene runtime. The client has several methods:
...
Gets the current value of the top-level JavaScript variable whose name is the given JavaScript string. It must be one of the variables that was captured by the code produced by (:ref:`sloppy-javascript-quine` ...) or (:ref:`picky-javascript-quine` ...).
...
Assigns to the top-level JavaScript variable whose name is the given JavaScript string. It must be one of the variables that was captured by the code produced by (:ref:`sloppy-javascript-quine` ...) or (:ref:`picky-javascript-quine` ...).
